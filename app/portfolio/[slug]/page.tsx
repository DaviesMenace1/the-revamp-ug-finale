        ...
        <section className="border-b border-border/70 px-5 py-14 sm:px-8 md:py-20 lg:px-16">
          <div className="mx-auto grid max-w-[1440px] gap-12 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <dl className="grid grid-cols-2 gap-x-8 gap-y-8 border-l border-border/70 pl-6 sm:pl-10">
              ...
              <div><dt className="text-[10px] uppercase tracking-[0.2em] text-primary">Sub-category</dt><dd className="mt-2 text-sm text-foreground">{valueOrFallback(project.subCategory, 'Bespoke interior')}</dd></div>
              <div><dt className="text-[10px] uppercase tracking-[0.2em] text-primary">Client</dt><dd className="mt-2 text-sm text-foreground">{valueOrFallback(project.clientName || project.client, 'Private client')}</dd></div>
              <div><dt className="text-[10px] uppercase tracking-[0.2em] text-primary">Lead designer</dt><dd className="mt-2 text-sm text-foreground">{valueOrFallback(project.designer, 'Revamp Design Team')}</dd></div>
