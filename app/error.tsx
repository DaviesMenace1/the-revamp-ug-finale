  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-background px-6 py-16 text-foreground">
      <div role="alert" className="w-full max-w-xl rounded border border-amber-300/70 bg-amber-50 p-4 text-amber-950 shadow-sm dark:border-amber-400/40 dark:bg-amber-950/40 dark:text-amber-50 sm:p-6">
        ...
        <h1 className="mt-3 font-serif text-3xl">This area needs another try.</h1>
        <p className="mt-3 text-sm leading-6">A temporary rendering issue interrupted this view. Your saved information was not changed; retry the current route or return to a safe page.</p>
        <div className="mt-5 flex flex-wrap gap-3">
          ...
          <Link href="/" className="inline-flex min-h-11 items-center rounded border border-amber-950 px-4 text-sm font-medium transition-colors hover:bg-amber-100 dark:border-amber-200 dark:hover:bg-amber-900/50">
            Return home
          </Link>
        </div>
      </div>
