        ...
        <div className="mx-auto flex h-[4.75rem] max-w-[1440px] items-center justify-between px-5 sm:px-8 lg:h-20 lg:px-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button type="button" onClick={() => setMenuOpen((open) => !open)} className="rounded-full p-2 text-ivory/80 transition hover:text-gold-light" aria-label={menuOpen ? 'Close account menu' : 'Open account menu'} aria-expanded={menuOpen}><Menu className="size-5" aria-hidden="true" /></button>
