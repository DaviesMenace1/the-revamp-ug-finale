        ...
        <div className="mx-auto max-w-7xl">
          ...
          <form onSubmit={handlePayWithFlutterwave} className="mt-10 grid gap-8 lg:grid-cols-[minmax(0,1fr)_380px] lg:gap-12">
            <div className="contents lg:block">
              <section className={`${activeStep !== 1 ? 'hidden lg:block' : ''} rounded-xl border border-border/70 bg-card p-5 shadow-lift sm:p-7`}>
              ...
              <div className="flex justify-between gap-3 lg:hidden"><Button type="button" variant="outline" onClick={() => setActiveStep(1)} className="min-h-11 rounded-md text-xs uppercase tracking-[0.12em]">Back to delivery</Button><span className="self-center text-[10px] uppercase tracking-[0.16em] text-muted-foreground">Step 2 of 2</span></div>
