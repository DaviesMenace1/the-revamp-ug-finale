...
import { ArrowRight, Building2, FileText, Percent, Users } from '@/components/ui/luxury-icons'
        ...
        <section className="relative overflow-hidden bg-obsidian px-5 pb-20 pt-36 text-ivory sm:px-8 md:pb-28 md:pt-48 lg:px-16">
          ...
          <div className="relative mx-auto max-w-[1440px]">
            ...
            <div className="mt-10 grid gap-8 border-t border-ivory/15 pt-8 md:grid-cols-[1fr_auto] md:items-end">
              ...
              <Link href="#apply" className="inline-flex min-h-11 items-center gap-2 text-xs uppercase tracking-[0.18em] text-gold underline-offset-4 hover:underline">Apply for trade access <ArrowRight className="size-4" /></Link>
            </div>
          </div>
        </section>
