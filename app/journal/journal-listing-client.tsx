  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background text-foreground">
          ...
          <>
            <section className="bg-background px-5 py-16 sm:px-8 sm:py-24 lg:px-12 lg:py-32">
              <div className="mx-auto max-w-[1440px]">
                <div className="mb-8 flex items-end justify-between gap-6 border-b border-foreground/15 pb-6"><div><p className="text-[10px] uppercase tracking-[0.28em] text-foreground/55">01 — Featured story</p><h2 className="mt-3 font-serif text-4xl font-light leading-none sm:text-6xl">In focus.</h2></div><span className="hidden text-[10px] uppercase tracking-[0.18em] text-foreground/60 sm:block">Latest from the studio</span></div>
        ...
        <section className="bg-foreground px-5 py-20 text-background sm:px-8 sm:py-28 lg:px-12 lg:py-36"><div className="mx-auto grid max-w-[1440px] gap-10 md:grid-cols-[1fr_0.65fr] md:items-end"><div><p className="text-[10px] uppercase tracking-[0.28em] text-background/55">03 — Keep looking</p><blockquote className="mt-5 max-w-4xl font-serif text-4xl font-light leading-[0.95] sm:text-6xl">A room becomes memorable through the decisions you almost miss.</blockquote></div><div className="md:pb-1"><p className="max-w-sm text-sm leading-7 text-background/65">The journal is a record of those decisions — in material, proportion, light and use.</p><div className="mt-7"><EditorialLink href="/services" dark>Explore the practice</EditorialLink></div></div></div></section>
      </main>
      <SiteFooter />
    </>
  )
