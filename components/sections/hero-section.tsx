...
const slides: Slide[] = [
  ...
  },
  {
    id: 2,
    type: 'video',
    src: 'https://res.cloudinary.com/r8epy5mg/video/upload/v1785487048/IMG_3268_kpqjhz.mov', // Replace with your video URL
    poster: '',
...
export function HeroSection() {
 ...
 // Constants
const SLIDE_DURATION = 7 // Duration in seconds
