...
export default async function ProfilePage() { const user = await currentUser(); if (!user) redirect('/sign-in?redirect_url=/user-profile'); return <main className="min-h-screen bg-background"><div className="mx-auto flex w-full max-w-7xl gap-12 px-6 py-10 md:px-10 md:py-16 lg:px-12"><AccountNavigation /><div className="min-w-0 flex-1"><CustomProfileSettings /></div></div></main> }
