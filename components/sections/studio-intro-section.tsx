  ...
  return (
    <section className="overflow-hidden border-b border-border/70 bg-background py-20 sm:py-28 lg:py-36">
      <div className="mx-auto grid max-w-[1440px] gap-12 px-4 sm:px-6 lg:grid-cols-[0.8fr_1.2fr] lg:gap-24 lg:px-12">
        <div className="flex items-start gap-4"><span className="mt-2 font-mono text-[10px] text-primary">01</span><div><p className="text-[10px] uppercase tracking-[0.28em] text-primary">A studio for considered living</p><p className="mt-6 max-w-xs text-sm leading-7 text-muted-foreground">We bring architecture, interiors, objects, and sourcing into one clear point of view.</p></div></div>
        <div>
