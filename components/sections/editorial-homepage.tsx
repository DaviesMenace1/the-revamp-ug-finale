...
// Real editorial photography sourced from Unsplash; semantic overlays keep copy readable in both themes.
const SECTION_BACKGROUNDS = {
  philosophy: 'https://images.unsplash.com/photo-1497366412874-3415097a27e7?auto=format&fit=crop&w=2400&q=85',
  process: 'https://images.unsplash.com/photo-1582528616547-b024caa3c7cc?auto=format&fit=crop&w=2400&q=85',
  journal: 'https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?auto=format&fit=crop&w=2400&q=85',
} as const

function SectionBackdrop({ src, alt }: { src: string; alt: string }) {
  return (
    <>
      <img src={src} alt={alt} className="absolute inset-0 h-full w-full object-cover opacity-[0.96] grayscale-0 saturate-[1.08] dark:opacity-[0.92]" loading="lazy" />
      <div className="absolute inset-0 bg-gradient-to-b from-black/10 via-transparent to-black/20 dark:from-black/20 dark:via-transparent dark:to-black/35" aria-hidden="true" />
    </>
  )
}
...
function PhilosophySection() {
  return (
    <section className="motion-reveal relative isolate overflow-hidden border-b border-foreground/10 bg-background px-5 py-20 sm:px-8 sm:py-28 lg:px-12 lg:py-36">
      <SectionBackdrop src={SECTION_BACKGROUNDS.philosophy} alt="Sunlit contemporary interior with glass dividers" />
      <div className="relative mx-auto grid max-w-[1440px] items-start gap-12 rounded-2xl border border-white/35 bg-white/35 p-4 shadow-[0_18px_60px_rgba(0,0,0,0.12)] backdrop-blur-md dark:border-white/15 dark:bg-black/30 sm:p-7 lg:grid-cols-[0.55fr_1fr_0.7fr] lg:gap-16">
        <div>
        ...
        <div>
          <h2 className="mx-auto max-w-3xl text-center font-serif text-[clamp(2.8rem,6vw,5.5rem)] font-light leading-[0.9] tracking-[-0.03em]">Why Choose<br /><span className="font-serif text-foreground/60">The Revamp UG</span></h2>
...
function ProcessSection() {
  ...
  return (
    <section className="relative isolate overflow-hidden border-y border-foreground/10 bg-canvas dark:bg-background px-5 py-20 sm:px-8 sm:py-28 lg:px-12 lg:py-32">
      <SectionBackdrop src={SECTION_BACKGROUNDS.process} alt="Architectural interior with people moving through a gallery-like space" />
      <div className="relative mx-auto grid max-w-[1440px] gap-12 rounded-2xl border border-white/35 bg-white/35 p-4 shadow-[0_18px_60px_rgba(0,0,0,0.12)] backdrop-blur-md dark:border-white/15 dark:bg-black/30 sm:p-7 lg:grid-cols-[0.75fr_1.25fr] lg:gap-20">
        <div><Eyebrow>The Revamp approach</Eyebrow><h1 className="mt-5 max-w-md font-serif text-5xl font-light leading-[0.95] sm:text-7xl">From vision<br /><span className="font-serif text-foreground/60">to reality.</span></h1><p className="mt-7 max-w-sm text-sm leading-7 text-foreground/60">We are not simply a designer who hands over drawings. We stay with the work until the final detail is in place.</p></div>
...
export function EditorialHomepage() {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-foreground px-5 py-24 text-center text-background sm:px-8 sm:py-32 lg:px-12 lg:py-40"><div className="mx-auto max-w-[1440px]"><Eyebrow light>Begin a project</Eyebrow><div className="mt-6 flex flex-col items-center gap-10"><h2 className="mx-auto max-w-5xl font-serif text-[clamp(3rem,7vw,7.5rem)] font-light leading-[0.83] tracking-[-0.035em]">Your space deserves<br /><span className="font-serif text-gold-light">a point of view.</span></h2><div className="flex shrink-0 flex-col items-center gap-3 md:pb-2"><TextLink href="/book-consultation" light>Book a consultation</TextLink><TextLink href="/contact" light>Get in touch</TextLink></div></div></div></section>
    </>
  )
}
