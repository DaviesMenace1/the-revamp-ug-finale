      ...
      <div className="mx-auto max-w-md text-center">
        ...
        <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-3">
          <input
            ...
            required
            disabled={isLoading}
            className="rounded-md border border-input bg-background px-4 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring disabled:opacity-20"
          />
          <Button
            type="submit"
