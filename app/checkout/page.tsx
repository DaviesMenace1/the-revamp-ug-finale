    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="px-4 pb-24 pt-28 sm:px-6 md:px-10 md:pt-36">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-8 grid grid-cols-3 gap-2" aria-label="Checkout progress">
