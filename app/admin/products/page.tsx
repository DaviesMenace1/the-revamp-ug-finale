...
import { Plus, Edit, Trash2, Search, X, Loader2, UploadCloud } from 'lucide-react'

// Defined Categories for the Dropdown
const CATEGORIES = [
  'Furniture',
  'Lighting',
  'Decor',
...
export default function AdminProducts() {
  ...
  // Core Form State with standard defaults filled
  ...
  const addColorVariant = () => {
    setColors([...colors, { label: 'Option', value: '#000000', images: [] }])
  }
    ...
    <div className="space-y-8 max-w-6xl mx-auto p-4 md:p-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Create, edit, and upload reactive Cloudinary media for product swatches
        </p>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full h-10 px-3 py-2 border bg-background text-foreground text-sm rounded-none focus:outline-none focus:ring-1 focus:ring-ring"
              >
                {CATEGORIES.map((cat) => (
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-2 border rounded-none bg-background text-foreground font-light resize-none focus:outline-none"
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Upload images via Cloudinary directly for each color option.
                </p>
              </div>
              <Button
                type="button"
      ...
      <div className="space-y-3">
        {loading ? (
          ...
          filteredProducts.map((product) => (
            <Card
              key={product.id}
              className="p-6 border-border/20 hover:border-primary/20 transition-colors"
            >
                  ...
                  <div className="grid grid-cols-4 gap-6 text-sm">
                    ...
                    <div>
                      ...
                      <p className="text-foreground font-medium">
                        {product.variants?.length || 0} Swatches/Fabrics
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-foreground font-medium">
                        {product.productImages?.length || 0} Cloudinary Photos
                      </p>
                    </div>
                  </div>
                </div>
