...
const ordersData = [
  { week: 'Week 1', orders: 24 },
  { week: 'Week 2', orders: 31 },
  { week: 'Week 3', orders: 19 },
    ...
    <div className="space-y-8 p-8">
      ...
      <div className="grid gap-6 md:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-light text-foreground">UGX 131M</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-light text-foreground">847</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-light text-foreground">342</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-light text-foreground">24</div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Order volume this month</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {[
              { action: 'New order placed', user: 'Client #2847', time: '2 hours ago' },
              { action: 'Project completed', user: 'The Nakasero Residence', time: '4 hours ago' },
              { action: 'New consultation booked', user: 'John Doe', time: '6 hours ago' },
              { action: 'Payment received', user: 'Order #5634', time: '8 hours ago' },
            ].map((activity, idx) => (
