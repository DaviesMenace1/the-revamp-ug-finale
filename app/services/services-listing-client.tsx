  ...
  return (
    <>
      <main className="min-h-screen bg-background">
        <section className="relative overflow-hidden bg-canvas dark:bg-background px-5 pb-16 pt-28 sm:px-8 sm:pb-24 sm:pt-36 lg:px-12 lg:pb-32"><div className="mx-auto grid max-w-[1440px] gap-10 lg:grid-cols-[1fr_0.62fr] lg:items-end"><div><p className="text-[10px] uppercase tracking-[0.28em] text-foreground/65">The Revamp House</p><h1 className="mt-5 max-w-5xl font-serif text-[clamp(3.8rem,9vw,8rem)] font-light leading-[0.82] tracking-[-0.04em]">Luxury living<br /><span className="font-serif text-foreground/60">redefined.</span></h1></div><div className="max-w-sm border-t border-foreground/20 pt-6 lg:mb-1"><p className="text-sm leading-7 text-foreground/75 sm:text-base">Bespoke solutions for refined spaces.</p><div className="mt-7"><EditorialLink href="/book-consultation">Begin a conversation</EditorialLink></div></div></div></section>
        ...
        <section className="bg-background px-5 py-20 sm:px-8 sm:py-28 lg:px-12 lg:py-36"><div className="mx-auto max-w-[1440px]"><div className="mb-10 grid gap-8 border-b border-foreground/15 pb-8 md:grid-cols-[0.65fr_1.35fr] md:items-end"><div><p className="text-[10px] uppercase tracking-[0.28em] text-foreground/65">The services</p><h2 className="mt-4 max-w-lg font-serif text-5xl font-light leading-[0.9] sm:text-7xl">Capabilities<br /><span className="font-serif text-foreground/60">with depth.</span></h2></div><div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between sm:gap-8"><p className="max-w-lg text-sm leading-7 text-foreground/60">Explore the disciplines that turn a vision into a finished space.</p><div className="flex items-center gap-2 text-[10px] uppercase tracking-[0.18em] text-foreground/50"><span>{totalResults}</span> {totalResults === 1 ? 'service' : 'services'}</div></div></div>
        ...
        <section className="bg-foreground px-5 py-24 text-background sm:px-8 sm:py-32 lg:px-12 lg:py-40"><div className="mx-auto max-w-[1440px]"><p className="text-[10px] uppercase tracking-[0.28em] text-white/55">The next step</p><div className="mt-6 flex flex-col gap-10 md:flex-row md:items-end md:justify-between"><h2 className="max-w-5xl font-serif text-[clamp(3.5rem,9vw,9rem)] font-light leading-[0.83] tracking-[-0.035em]">Your space deserves<br /><span className="font-serif text-gold-light">a point of view.</span></h2><div className="flex shrink-0 flex-col items-start gap-3 md:pb-2"><EditorialLink href="/book-consultation" light>Book a consultation</EditorialLink><EditorialLink href="/contact" light>Get in touch</EditorialLink></div></div></div></section>
      </main>
    </>
  )
}
