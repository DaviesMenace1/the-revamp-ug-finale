...
export default async function ClientDashboard() {
  ...
  const projectCountResult = await safeQuery(
    db
      .select({ value: count() })
      .from(projects)
  ...
  const consultationCountResult = await safeQuery(
  ...
  const recentOrdersResult = await safeQuery(
    db
  ...
  const recentConsultationsResult = await safeQuery(
    db
