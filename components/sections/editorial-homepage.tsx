...
function ServiceWorld({ services, loading }: { services: Service[]; loading: boolean }) {
  ...
  return (
    <section className="bg-canvas bg-background bg-[url('https://res.cloudinary.com/r8epy5mg/image/upload/v1785487027/5a4511ac98f0cf61f1c938504c4cc9_c34kyo.jpg')] bg-cover bg-center bg-no-repeat px-5 py-12 sm:px-8 sm:py-28 lg:px-12 lg:py-36">
...
function CollectionsPreview({ products }: { products: Product[] }) {
  ...
  return (
    <section className="bg-background bg-[url('https://res.cloudinary.com/r8epy5mg/image/upload/v1785487051/IMG_3513_umthlq.jpg')] bg-cover bg-center bg-no-repeat px-5 py-20 sm:px-8 sm:py-28 lg:px-12 lg:py-36">
...
function ProcessSection() {
  ...
  return (
    <section className="border-y border-foreground/10 bg-canvas bg-background bg-[url('https://res.cloudinary.com/r8epy5mg/image/upload/v1785487067/IMG_3903_gyzbre.jpg')] bg-cover bg-center bg-no-repeat px-5 py-20 sm:px-8 sm:py-28 lg:px-12 lg:py-32">
...
function JournalSection({ articles, loading }: { articles: Article[]; loading: boolean }) {
  ...
  return (
    <section className="border-t border-foreground/10 bg-canvas bg-background bg-[url('https://res.cloudinary.com/r8epy5mg/image/upload/v1785487078/L3D124S57ENDOVLZRRYUWLZS6LUFX7Y3WLA8_4000x3000_gb14hk.jpg')] bg-cover bg-center bg-no-repeat px-5 py-20 sm:px-8 sm:py-28 lg:px-12 lg:py-32">
